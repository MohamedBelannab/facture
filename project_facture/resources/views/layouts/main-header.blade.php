					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="{{ route('MarkAsreadAll') }}">تعيين قراءة الكل</a></span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">عدد الاشعارات الغير المقروءة  <span style="font-weight: bolder;font-size: 13px;" id="notifications_count">{{ auth()->user()->unreadNotifications->count() }}</span></p>
									</div>
									@can('الاشعارات')
											...
											@foreach (auth()->user()->unreadNotifications as $notification)
												<div class="main-notification-list Notification-scroll">
													<a class="d-flex p-3 border-bottom"
														...
														<div class="mr-3">
															<h5 style="font-size: 12px" class="notification-label mb-1">{{ $notification->data['title'] }}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset(Auth::user()->avatar)}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset(Auth::user()->avatar)}}" class=""></div>
									...
									<a class="dropdown-item" href="{{ route('users.edit', Auth::user()->id) }}"><i class="bx bx-cog"></i>تعديل معلوماتي</a>
									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> اعدادات </a>
