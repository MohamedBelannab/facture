...
@section('content')
	...
	<div class="row row-sm">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										href="#exampleM" title="تعديل"><i class="las la-pen"></i></a>
										@endcan
		...
		<!--/div-->
				...
				<!-- End Basic modal -->
				<!-- edit -->
				<div class="modal fade" id="exampleM" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
					aria-hidden="true">
					<div class="modal-dialog" role="document">
...
<script>
    $('#exampleM').on('show.bs.modal', function(event) {
