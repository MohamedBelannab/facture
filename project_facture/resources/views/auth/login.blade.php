...
@section('title')
تسجيل الدخول - اوكسجين للادارة القانونية
@stop
@section('css')
                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <form method="POST" action="{{ route('login') }}">
												...
												<div class="row row-xs">
													<div class="col-sm-6">
														<a href="{{ route('social_login', 'facebook') }}" class="btn btn-block"> تسجيل من فيسبوك<i class="fab fa-facebook-f"></i></a>
													</div>
													<div  class="col-sm-6 mg-t-10 mg-sm-t-0">
														<a href="{{ route('social_login', 'google') }}" class="btn btn-danger btn-block">تسجيل من غوغل <i class="fab fa-google"></i> </a>
													</div>
												</div>
                                            </form>
